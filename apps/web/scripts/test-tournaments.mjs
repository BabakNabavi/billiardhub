...
t('دسته‌ی توپ فهرستِ رشته‌محور دارد',
  newAd.includes(`'توپ اسنوکر', 'توپ پاکت بیلیارد', 'توپ کارامبول', 'کیوبال', 'توپ تکی', 'سایر'`),
  'گزینه‌ها با عدد شروع می‌شدند و «توپ تکی» اصلاً در فهرست نبود');
...
t('نوارِ فوری هم‌ارتفاع و اسکرول‌پذیر است',
  /\.mk-urgcell > \* \{ width: 100%; height: 100%; \}/.test(read('app/shop/page.tsx')),
