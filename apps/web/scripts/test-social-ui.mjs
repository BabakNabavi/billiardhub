...
const TEST_STORIES = [
  {
    ...
    mediaUrl: `${BASE}/images/Logo/bh-icon-512-v2.png`, caption: 'استوری آزمایشی یک', createdAt: Date.now(),
  },
  {
    id: 'st-uitest-2', ownerKey: USER.id, userName: 'کاربر آزمایشی',
    roleKey: 'player', roleLabel: 'بازیکن', roleColor: '#06b6d4', avatar: 'ک',
    mediaUrl: `${BASE}/images/Logo/bh-icon-512-v2.png`, caption: 'استوری آزمایشی دو', createdAt: Date.now(),
  },
]
