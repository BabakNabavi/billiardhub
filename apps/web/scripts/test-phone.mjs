...
/* هیچ فهرستِ سفیدی از پیشوندها وجود ندارد و نباید داشته باشد.

   نسخه‌ی قبلی `0900` را رد می‌کرد چون آن را «تخصیص‌نیافته» فرض کرده
   بودم. غلط بود — بازه‌ی واقعیِ ایرانسل است — و روی سایتِ زنده جلوی
   ثبت‌نامِ دارندگانِ آن شماره‌ها را گرفت. این تست‌ها هستند تا آن اشتباه
   دوباره برنگردد. */
...
console.log('\nآنچه واقعاً رد می‌شود: شکلِ نادرست')
