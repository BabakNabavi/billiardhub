...
/* ─────────────────────────────────────────────────────────────
   کشویِ سفارشی — جایگزینِ <select> بومیِ سیستم.

   selectِ بومی در هر سیستم‌عامل شکلِ خودش را دارد و با بقیه‌ی فرم
   جور در نمی‌آید؛ این‌جا همان تینتِ طلاییِ برند، تیکِ گزینه‌ی
   انتخاب‌شده، و بازشدنِ رو به بالا وقتی زیرش جا نیست.
   ───────────────────────────────────────────────────────────── */
