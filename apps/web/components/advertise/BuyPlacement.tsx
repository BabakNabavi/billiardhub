...
interface Option {
  ...
  /* فقط فروختنی‌ها در این تب می‌آیند؛ بقیه در «درخواست سفارشی» */
  sellable?: boolean
  plans: Plan[]
}
  ...
  if (opts.length === 0) {
    return (
      <div style={{ ...CARD, fontSize: 13, color: SEC, lineHeight: 2 }}>
        <div style={{ fontWeight: 800, color: INK, marginBottom: 8 }}>
          هنوز جایگاهی برای خرید مستقیم باز نشده است
        </div>
        جایگاه‌های تبلیغاتی — بنرهای صفحه‌ی اصلی و بیلیارد بازار، و
        ...
        <span style={{ fontSize: 12, color: MUT }}>
          اگر باشگاه، فروشگاه یا تولیدکننده‌اید و نقشتان هنوز تأیید نشده، پس از تأیید،
          جایگاه‌های مرتبط این‌جا ظاهر می‌شوند.
        </span>
      </div>
    )
  }
