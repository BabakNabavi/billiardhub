...
/* ─────────────────────────────────────────────────────────────
   دکمه‌ی «بازگشت» پنل ادمین — یک شکل برای همه‌ی صفحه‌ها.

   تا امروز ۱۶ صفحه‌ی ادمین هیچ راه برگشتی نداشتند و تنها راه، دکمه‌ی
   Back مرورگر بود. چند صفحه هم لینک برگشت داشتند ولی هرکدام با
   ظاهر و متن خودش.
...
/* نام فارسی بخش‌ها — برای «بازگشت به …» */
