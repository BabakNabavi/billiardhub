...
/* دکمه‌ی علاقه‌مندی — مشترک باشگاه، مربی، فروشگاه و محصول.

   وضعیت اولیه از فهرست علاقه‌مندی‌های کاربر می‌آید که یک‌بار برای کل
   ...
   کرد برمی‌گردد. انتظار رفت‌وبرگشت برای یک قلب، کند به‌نظر می‌رسد.
   ───────────────────────────────────────────────────────────── */
...
/* کش سبک درون‌صفحه‌ای: چند کارت روی یک صفحه نباید هرکدام
...
export default function FavoriteButton({
  ...
  const toggle = async (e: React.MouseEvent) => {
    /* کارت باشگاه خودش یک لینک است — کلیک قلب نباید صفحه را عوض کند */
