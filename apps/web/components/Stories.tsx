...
/* ── Story viewer (unchanged logic, same UX) ── */
...
/* ── Stories strip — modernised compact design ── */
  ...
  return (
    <>
      <style>{`
        ...
        .st-item:hover .st-ring { box-shadow: 0 4px 16px rgba(0,0,0,0.28); }
        .st-inner {
        ...
        .st-name {
          ...
          overflow: hidden; text-overflow: ellipsis; max-width: 58px;
          line-height: 1.2;
        }
      `}</style>
      ...
      <div className="st-strip">
        ...
        {groups.map((g, i) => {
          ...
          return (
            <div key={g.userId} className="st-item" onClick={() => openStory(i)}>
              <div className="st-ring" style={{
                ...
                <div className="st-inner" style={{
                  background: `linear-gradient(135deg,${g.roleColor}28,${g.roleColor}0E)`,
                }}>
                  {g.userAvatar}
                </div>
              </div>
