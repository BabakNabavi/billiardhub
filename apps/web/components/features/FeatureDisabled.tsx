...
/* صفحه‌ی «این بخش موقتاً غیرفعال است».
   ...
   جایگزین صفحه‌ی خالی یا ریدایرکت بی‌توضیح. کاربری که لینک دایرکت را
   بوکمارک کرده یا از تاریخچه برمی‌گردد، به‌جای یک صفحه‌ی شکسته یک پیام
   روشن می‌بیند و راه برگشت دارد.

   عمداً هیچ جزئیاتی از دلیل فنی، نام پرچم یا زمان‌بندی نمی‌گوید. */
export default function FeatureDisabled({
  title = 'این بخش موقتاً غیرفعال است',
  note = 'این قابلیت در حال به‌روزرسانی است و به‌زودی باز می‌گردد.',
