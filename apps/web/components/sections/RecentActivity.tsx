    ...
    <ScrollReveal>
      <section style={{ marginBottom: '110px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '28px' }}>
          <div>
            <div style={{ fontSize: '10px', color: 'rgba(199,166,106,0.6)', letterSpacing: '0.28em', fontWeight: 700, marginBottom: '8px', textTransform: 'uppercase' }}>LIVE ACTIVITY</div>
            <h2 style={{ fontSize: 'clamp(22px, 2.8vw, 29px)', fontWeight: 900, color: '#111111', margin: 0, letterSpacing: '-0.025em' }}>
              فعالیت‌های اخیر
            </h2>
          </div>
          {/* Live dot */}
