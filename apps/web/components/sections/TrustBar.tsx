    ...
    <div style={{
      ...
      <div style={{ display: 'flex', animation: 'trustScroll 24s linear infinite', gap: '0', width: 'max-content' }}>
        {[...signals, ...signals].map((s, i) => (
          <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '0 36px', whiteSpace: 'nowrap', borderLeft: i > 0 ? '1px solid rgba(0,0,0,0.05)' : 'none', color: 'rgba(0,0,0,0.42)', fontSize: '14px', fontWeight: 500 }}>
