                    ...
                    {(() => {
                      if (user.primaryRole === 'admin') {
                        ...
                        return [
                          ...
                          /* ادمین هم می‌تواند آگهی ثبت کند — و تا امروز هیچ
                             راهی به آگهی‌های خودش نداشت، چون منوی ادمین
                             عمداً مینیمال است و فقط دو گزینه داشت. */
                          { href: '/dashboard/shop', label: 'آگهی‌های من', icon: <ShoppingBag size={13} /> },
                          /* ── چرا این‌جا ──
