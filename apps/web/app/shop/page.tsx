...
const ALL_PRODUCTS: Product[] = [
  ...
  { id:'9',  title:'دستکش بیلیارد Riley Pro',     brand:'RILEY',     category:'accessory', price:320000,  rating:4.7, reviewCount:52, stock:20, condition:'new',      city:'تهران',  img:img1,                                               isOfficialStore:false, seller:'مریم احمدی',         tags:['دستکش','حرفه‌ای'] },
  { id:'10', title:'توپ‌های پاکت Cyclop Galaxy',  brand:'CYCLOP',    category:'ball',      price:3200000,   rating:4.6, reviewCount:21, stock:6,  condition:'new',      city:'اصفهان', img:img3, isNew:true,                   isOfficialStore:false, seller:'نیما کریمی',         tags:['پاکت','کره‌ای'] },
