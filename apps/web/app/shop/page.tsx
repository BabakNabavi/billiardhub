      ...
      <div style={{
        ...
        <Link href="/shop" style={{
          ...
          <div style={{
            ...
            boxShadow: '0 2px 10px rgba(199,166,106,0.28)',
          }}>
        ...
        <form onSubmit={onSearch} style={{ flex: 1, position: 'relative' }}>
          ...
          {!searchInput && !focused && (
            <div style={{
              ...
              pointerEvents: 'none', zIndex: 1, fontSize: 14,
              display: 'flex', alignItems: 'center', gap: 3, direction: 'rtl',
            }}>
          ...
          <input
            ...
            style={{
              ...
              backdropFilter: LQ.blur,
              WebkitBackdropFilter: LQ.blur,
        ...
        {user ? (
          ...
          <Link href="/login" style={{
            textDecoration: 'none', flexShrink: 0,
            display: 'flex', alignItems: 'center', gap: 7,
            background: LQ.bgGold,
            backdropFilter: LQ.blur,
            WebkitBackdropFilter: LQ.blur,
            border: LQ.borderGold,
            borderRadius: 10, padding: '8px 16px',
            boxShadow: LQ.shadowGold,
            transition: 'all 0.25s',
          }}>
      ...
      <div style={{
        ...
        <div key={active} style={{ maxWidth: 460, animation: 'hsIn 0.55s cubic-bezier(0.22,1,0.36,1) both' }}>
          ...
          <p style={{
            ...
            margin: '0 0 28px', lineHeight: 1.8,
          }}>
            {slide.sub}
          </p>
          {/* CTA — LQ gold */}
          <Link href={slide.href} style={{
            ...
            boxShadow: '0 8px 32px rgba(199,166,106,0.18), inset 0 1px 0 rgba(255,255,255,0.25)',
        ...
        {SLIDES.map((_, i) => (
          <button key={i} onClick={() => setActive(i)}
            style={{
              ...
              boxShadow: i === active ? '0 0 10px rgba(199,166,106,0.55)' : 'none',
...
export default function ShopPage() {
  ...
  return (
    <>
      ...
      <div style={{ minHeight: '100vh', background: '#0E0C09' }}>
        <ShopTopBar
