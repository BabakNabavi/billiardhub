...
export const SHOP_PRODUCTS: ShopProduct[] = [
  ...
  { id: 6,  cat: 'case-bag', img: '/images/shop/accessori.png',       name: 'کیف چوب بیلیارد دو قسمتی چرم',         brand: 'Predator', desc: 'کیف چرم طبیعی با دو محفظه‌ی مجزا برای شفت و بات، آستر مخملی ضدخش و بند دوشی قابل تنظیم.', price: 850000,   old: 970000,   disc: 12, rating: 4.5, reviews: 33,  sales: 520,  ...S2 },
  { id: 7,  cat: 'cue',      img: '/images/shop/cue_billiard.jpg',    name: 'چوب کربن فایبر Mezz EC7-CF',           brand: 'Mezz',     desc: 'شفت تمام‌کربن با تیپ کامویی اورجینال. سختی و دقت ضربه در کنار وزن ایده‌آل ۱۹ اونس، انتخاب بازیکنان حرفه‌ای.', price: 6500000,  old: 7100000,  disc: 8,  rating: 4.6, reviews: 71,  sales: 260,  ...S2 },
  { id: 8,  cat: 'ball',     img: '/images/shop/Ball.jpg',            name: 'توپ Cyclop Omega Pool Set',             brand: 'Aramith',  desc: 'ست کامل توپ پاکت بیلیارد Cyclop با رنگ‌بندی شفاف و مقاوم در برابر زردشدگی. مناسب باشگاه و منزل.', price: 950000,   old: 1120000,  disc: 15, rating: 4.4, reviews: 58,  sales: 190,  ...S2 },
  { id: 9,  cat: 'table',    img: '/images/shop/Home_table.jpg',      name: 'میز بیلیارد خانگی — پایه چوب ماسیو',  brand: 'Rasson',   desc: 'میز ۸ فوت خانگی با بدنه‌ی چوب راش و ماهوت ضدآب. طراحی کلاسیک مناسب فضای منزل و دفتر کار، همراه ست کامل بازی.', price: 18000000, old: 19000000, disc: 5,  rating: 4.9, reviews: 27,  sales: 42,   ...S2 },
  { id: 10, cat: 'chalk',    img: '/images/shop/pool_chalk_2.jpg',    name: 'گچ Predator 1080 Pure — ۵ عددی',       brand: 'Predator', desc: 'گچ سیلیکونی خالص ۱۰۸۰ با چسبندگی فوق‌العاده به تیپ و کمترین پخش گرد. بسته‌ی ۵ عددی اورجینال.', price: 220000,   old: 245000,   disc: 10, rating: 4.5, reviews: 39,  sales: 610,  ...S2 },
  { id: 11, cat: 'table',    img: '/images/shop/snooker-table-2.jpg', name: 'میز اسنوکر Pro-Line ۱۲ فوتی',          brand: 'Rasson',   desc: 'میز اسنوکر سایز کامل مسابقات با فریم فولادی و اسلیت ۴۵ میلی‌متری. مناسب باشگاه‌های حرفه‌ای، با خدمات نصب سراسری.', price: 68000000, old: 75000000, disc: 9,  rating: 4.8, reviews: 46,  sales: 175,  ...S2 },
  { id: 12, cat: 'table',    img: '/images/shop/Pro_table.jpg',       name: 'میز بیلیارد حرفه‌ای پارچه ایتالیایی', brand: 'BCE',      desc: 'میز ۹ فوت پاکت با ماهوت ایتالیایی سرعت‌بالا و جیب‌های چرمی دست‌دوز. تعادل بی‌نقص برای بازی حرفه‌ای و نمایشی.', price: 32000000, old: 36000000, disc: 11, rating: 4.7, reviews: 52,  sales: 88,   ...S2 },
]
