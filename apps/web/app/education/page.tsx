    ...
    <div style={{ minHeight: '100vh', background: '#F7F7F5', color: '#111111', fontFamily: 'Vazirmatn, sans-serif', direction: 'rtl' }}>
      ...
      <div style={{ position: 'relative', overflow: 'hidden', background: 'linear-gradient(180deg,#111111 0%,#1a1a1a 100%)', padding: 'clamp(40px,5vw,72px) clamp(16px,4vw,40px) clamp(32px,4vw,56px)' }}>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', position: 'relative' }}>
          ...
          <div style={{ color: 'rgba(255,255,255,0.45)', fontSize: 'clamp(15px, 2.2vw, 18px)', maxWidth: 520, lineHeight: 1.7, marginBottom: 28 }}>
      ...
      <div style={{ background: '#111111', padding: 'clamp(40px,5vw,64px) clamp(16px,4vw,40px)', margin: 'clamp(24px,4vw,48px) 0 0', textAlign: 'center' }}>
        <div style={{ maxWidth: 560, margin: '0 auto' }}>
          <div style={{ fontSize: 'clamp(22px, 4.4vw, 31px)', fontWeight: 900, marginBottom: 12, color: '#FFFFFF' }}>
            می‌خواهی مربی بیلیارد باشی؟
          </div>
          <div style={{ color: 'rgba(255,255,255,0.45)', fontSize: 17, lineHeight: 1.7, marginBottom: 24 }}>
            اگر تجربه تدریس داری، دوره خودت را در بیلیارد هاب منتشر کن و به هزاران نفر آموزش بده
          </div>
          <button style={{ background: `linear-gradient(135deg,${GOLD},${GOLD_DARK})`, color: '#fff', border: 'none', borderRadius: 14, padding: '14px 36px', fontSize: 17, cursor: 'pointer', fontWeight: 800, fontFamily: 'inherit', boxShadow: `0 8px 24px rgba(199,166,106,0.30)` }}>
            همکاری با ما ←
          </button>
        </div>
      </div>
