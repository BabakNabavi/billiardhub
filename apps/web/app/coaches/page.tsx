...
const COACH_SLIDES = [
  ...
  { title:'از مبتدی تا حرفه‌ای',  sub:'مسیر پیشرفت تو' },
  { title:'قهرمان بساز',           sub:'با مربیان ملی‌پوش' },
  { title:'جلسات خصوصی',           sub:'برنامه‌ی تمرینی اختصاصی' },
  { title:'جامعه‌ی مربیان',        sub:'بیلیارد هاب، کنار تو' },
]
  ...
  return (
    <article className="ccard" style={{
      ...
      <div style={{ position:'relative', paddingTop:'46%', flexShrink:0, overflow:'hidden', background:'linear-gradient(115deg,#0c1424 0%,#17253f 55%,#1e2f4d 100%)' }}>
        ...
        <img loading="lazy" decoding="async" src="/images/Logo/bh-header-v4.png" alt="" style={{ position:'absolute', top:'9px', insetInlineEnd:'10px', height:'22%', width:'auto', opacity:0.9 }}/>
