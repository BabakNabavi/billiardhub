          ...
          <div style={{ maxWidth:1000, margin:'0 auto', padding:'0 clamp(16px,4vw,32px)' }}>
            <div style={{ display:'flex', gap:'clamp(14px,3vw,24px)', alignItems:'flex-end', marginTop:-44, flexWrap:'wrap', paddingBottom:20 }}>
              ...
              <div style={{ position:'relative', flexShrink:0 }}>
                <div style={{ width:'clamp(88px,18vw,120px)', height:'clamp(88px,18vw,120px)', borderRadius:'clamp(22px,5vw,30px)', background:`linear-gradient(135deg,${lvlMeta.bg}0.3),${lvlMeta.bg}0.1))`, border:`3px solid ${lvlMeta.color}40`, display:'flex', alignItems:'center', justifyContent:'center', fontSize:'clamp(28px,7vw,42px)', fontWeight:900, color:lvlMeta.color, overflow:'hidden', boxShadow:`0 0 40px ${lvlMeta.bg}0.2), 0 8px 32px rgba(0,0,0,0.5)`, position:'relative', zIndex:1 }}>
                  {player.avatar
