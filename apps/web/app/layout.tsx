...
export const metadata: Metadata = {
  ...
  /* احرازِ مالکیتِ دامنه برای اینماد.
     اینماد چهار راه می‌دهد و دو تایش این‌جاست: همین متاتگ، و فایلِ
     خالیِ `public/48195948.txt` که روی /48195948.txt سرو می‌شود.
     روشِ ایمیل ممکن نبود چون info@billiardhub.net هنوز راه نیفتاده.

     ⚠️ این متاتگ باید بماند — اینماد دوره‌ای دوباره بررسی می‌کند و با
     برداشتنش نشان باطل می‌شود. */
