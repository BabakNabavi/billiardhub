        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ position: 'relative', width: '100%', aspectRatio: '16/9', background: '#000', maxHeight: '56vw' }}>
            ...
            <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: '12px 16px', display: 'flex', alignItems: 'center', gap: 10, background: 'linear-gradient(0deg,rgba(0,0,0,0.85),transparent)' }}>
              ...
              <button style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#fff', fontSize: 16, padding: 0 }}>🔊</button>
          ...
          <div style={{ margin: '12px 16px 0', borderRadius: 16, overflow: 'hidden', background: '#FFFFFF', border: '1px solid rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 80px 1fr', alignItems: 'center', padding: '14px 16px' }}>
              ...
              <div style={{ textAlign: 'center' }}>
                <div style={{ fontSize: 12, fontWeight: 600, marginBottom: 4 }}>{stream.player2}</div>
                <div style={{ fontSize: 40, fontWeight: 900, color: '#a78bfa', lineHeight: 1 }}>{stream.score2}</div>
              </div>
            </div>
          </div>
              ...
              {comments.map(c => (
                <div key={c.id} style={{ display: 'flex', alignItems: 'flex-start', gap: 8 }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <button onClick={() => toggleLike(c.id)} style={{ marginTop: 4, display: 'flex', alignItems: 'center', gap: 4, background: 'none', border: 'none', cursor: 'pointer', color: liked[c.id] ? '#ef4444' : '#4b5563', fontSize: 11, fontFamily: 'Vazirmatn, sans-serif', padding: 0 }}>
