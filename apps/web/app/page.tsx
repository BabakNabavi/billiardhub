...
/* ⚠️ موقت — احرازِ مالکیتِ دامنه برای اینماد (روشِ «تغییر عنوان صفحه»).
   اینماد می‌خواهد کدِ ۴۸۱۹۵۹۴۸ در عنوانِ صفحه‌ی اصلی دیده شود. دو روشِ
   دیگر (متاتگ و فایلِ /48195948.txt) از قبل سرِ جایشان هستند ولی رد
   شدند — این آزمون نشان می‌دهد مشکل از محتوا است یا از دسترسیِ خزنده.

   بعد از گرفتنِ تأیید، این پیشوند برداشته شود. */
