...
const SAMPLE: Record<PatternKey, string[]> = {
  ...
  /* گیرنده‌اش برگزارکننده است — `{0}` نامِ مالک و `{1}` نامِ
     ثبت‌نام‌کننده، همان ساختارِ `booking_for_owner` */
  tournament_reg_for_owner: ['مدیر آزمایشی', 'بازیکن آزمایشی', 'مسابقات نمونه', '۵', '۱۶'],
