/* ─────────────────────────────────────────────────────────────
   ...
   قیمت و سهمیه همیشه از رکوردِ سرور خوانده می‌شوند، نه از کلاینت؛
   و هنگام سفارش یک عکسِ لحظه‌ای از پلن ذخیره می‌شود تا تغییرِ بعدیِ
   قیمت روی سفارشِ باز اثر نگذارد.
   ───────────────────────────────────────────────────────────── */
