...
export const PATTERNS = [
  ...
  /* ── امنیتِ حساب ──
     این دو با بقیه فرق دارند: خبرِ یک اتفاقِ عادی نیستند، بلکه تنها
     راهِ فهمیدنِ کاربر از چیزی‌اند که ممکن است کارِ خودش نباشد.
     `login_locked` حتی وقتی می‌رود که کاربر پشتِ سایت نیست. */
  'password_reset_otp',
  'login_locked',
