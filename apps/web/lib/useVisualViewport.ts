...
export interface VP {
  height: number      // ارتفاعِ ناحیه‌ی دیدنی (بالای کیبورد)
  offsetTop: number   // مقدارِ جابجاییِ iOS هنگام بازشدنِ کیبورد (برای جبران با transform)
  kb: number          // ارتفاعِ کیبورد
}

/* ردیابیِ دقیقِ VisualViewport — منبعِ واحدِ حقیقت برای «کیبورد کجاست».
