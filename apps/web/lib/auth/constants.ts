/* نام کوکی‌ها و عمرها — بدون هیچ وابستگی.
   عمداً از session.ts جدا است: middleware روی Edge اجرا می‌شود و اگر
   فایلی که jsonwebtoken را import می‌کند به آن برسد، باندل Edge
...
/* عمر توکن‌های نسل قدیم که هنوز در localStorage بعضی کاربران است */
export const LEGACY_TTL_SEC  = 7 * 24 * 60 * 60

/* مسیرهایی که بدون نشست دیده نمی‌شوند */
