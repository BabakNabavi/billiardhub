/* ─────────────────────────────────────────────────────────────
   شکلِ داده‌ای که کارت‌های صفحه‌ی اصلی می‌گیرند.

   عمداً در ماژولِ خودش است، نه داخلِ `app/HomeClient.tsx`:
   ...
   از دلِ یک فایلِ `'use client'` یک یالِ شکننده در گرافِ ماژول‌ها
   می‌سازد — همان کاری که یک‌بار مرزِ سرور/کلاینت را جابه‌جا کرد و
