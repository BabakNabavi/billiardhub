...
/* قوانینِ عمومیِ رزرو — جدا از قوانینِ لغو، چون کاربر پیش از پرداخت
   باید هر دو را دیده باشد. یک منبعِ واحد تا در صفحه‌ی رزرو، صفحه‌ی
   قوانین و پیامِ تأیید یک چیز نوشته شود. */
export const BOOKING_TITLE = 'قوانین رزرو باشگاه'
export const BOOKING_RULES: string[] = [
  'رزرو تنها پس از پرداخت کامل مبلغ قطعی می‌شود؛ تا آن لحظه ساعتِ انتخابی برای شما نگه داشته نمی‌شود.',
  'ساعتِ رزرو به وقتِ رسمیِ ایران است و بازه‌ها ساعت‌به‌ساعت محاسبه می‌شوند.',
  'حضور در باشگاه باید در همان ساعتِ رزروشده باشد؛ تأخیر بیش از ۱۵ دقیقه، حقِ میز را از بین می‌برد و مبلغ بازگردانده نمی‌شود.',
  'هزینه‌ی بازیکنِ اضافه بر اساسِ نرخِ اعلام‌شده‌ی همان میز به مبلغ افزوده می‌شود.',
  'باشگاه می‌تواند رزروِ روزِ جاری را ببندد؛ در این حالت تنها روزهای آینده قابلِ رزرو هستند.',
  'در صورتِ بروزِ مشکلِ فنی برای میز، باشگاه موظف است میزِ جایگزین بدهد یا کلِ مبلغ را بازگرداند.',
  'مسئولیتِ رعایتِ مقرراتِ داخلیِ باشگاه بر عهده‌ی رزروکننده است.',
]
