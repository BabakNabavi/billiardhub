...
export const BOOKING_RULES: string[] = [
  ...
  /* بندِ «ساعت به وقت رسمی ایران است و بازه‌ها ساعت‌به‌ساعت محاسبه
     می‌شوند» برداشته شد: هر دو نکته از خودِ صفحه‌ی رزرو پیداست —
     ساعت‌ها همان‌طور که هستند نشان داده می‌شوند و بازه‌ها را کاربر
     ساعت‌به‌ساعت انتخاب می‌کند. */
  'هزینه‌ی بازیکن اضافه بر اساس نرخ اعلام‌شده‌ی همان میز به مبلغ افزوده می‌شود.',
  /* بندِ «باشگاه می‌تواند رزرو روز جاری را ببندد» برداشته شد: در
     صفحه‌ی رزرو، ساعت‌های بسته از اول نشان داده نمی‌شوند، پس این بند
     چیزی روشن نمی‌کرد و فقط شبهه‌ی «ممکن است رزروم لغو شود» می‌ساخت. */
