...
/* دسترسی سرور به دیتابیس + احراز هویت + ثبت رد عملیات مالی.
   همه‌ی نوشتن‌های مالی از توابع اتمیک Postgres عبور می‌کنند. */
...
/** کاربر درخواست — اول کوکی نشست، بعد هدر Authorization.
...
/** آیا این کاربر مالک/مدیر همین باشگاه است؟ (RBAC) */
...
/** ثبت رد عملیات حساس (بدون شکستن جریان اصلی در صورت خطا) */
