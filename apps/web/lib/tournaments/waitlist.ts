...
/* ارتقای نفرِ اولِ صفِ انتظار وقتی صندلی آزاد می‌شود.

   هرجا یک ثبت‌نامِ قطعی از بین می‌رود (بازپرداخت، لغو، انقضای پرداخت)
   باید صدا زده شود — وگرنه لیستِ انتظار فقط یک فهرستِ تزئینی است.

   خودش بی‌صداست: شکستِ ارتقا نباید عملیاتِ اصلی (که پول در آن
