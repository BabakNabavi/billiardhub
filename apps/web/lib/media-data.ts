...
export const MEDIA_VIDEOS: MediaVideo[] = [
  {
    ...
    title: 'مسترکلاس برک بیلدینگ؛ از ۳۰ به ۷۰ در چهار قدم',
    ...
    src: DEMO_SRC,
    description: [
      'در این مسترکلاس، مسیر رسیدن از برک‌های ۳۰تایی به برک‌های بالای ۷۰ را قدم‌به‌قدم می‌سازیم: انتخاب توپ درست، زاویه‌ی ورود به رنگی‌ها، مدیریت کوشن و برنامه‌ریزی سه‌ضربه‌ای.',
      'تمرین‌های هر بخش را می‌توانید با هر میزی تکرار کنید؛ نسخه‌ی PDF برنامه‌ی تمرین در کانال آکادمی منتشر شده است.',
    ],
    tags: ['برک بیلدینگ', 'اسنوکر', 'آموزش پیشرفته'],
    featured: true,
  },
  {
    ...
    src: DEMO_SRC,
    description: [
      'خلاصه‌ی کامل فینال تهران مسترز با گزارش اختصاصی؛ از سیفتی‌های نفس‌گیر فریم ششم تا کلیرنس تاریخی فریم آخر.',
    ],
  ...
  },
  {
    ...
    title: 'کنترل توپ سفید برای شروع‌کننده‌ها؛ سه تمرین طلایی',
    ...
    src: DEMO_SRC,
    description: [
      'استاپ‌شات، فالو و درا — سه ضربه‌ای که پایه‌ی هر پوزیشن‌پلی هستند. با سه تمرین ساده که فقط به یک توپ نیاز دارند.',
    ],
  ...
  },
  {
    ...
    src: DEMO_SRC,
    description: [
      'قهرمان تازه‌ی جهان از شب فینال می‌گوید؛ از استرس فریم آخر تا لحظه‌ای که تصمیم گرفت به‌جای سیفتی، سراغ قرمز آخر برود.',
    ],
  ...
  },
  {
    ...
    src: DEMO_SRC,
    description: [
      'با ریگ تست ثابت، دیفلکشن سه شفت کربنی و دو شفت افرا را اندازه گرفتیم؛ اعداد، جدول مقایسه و جمع‌بندی خرید.',
    ],
  ...
  },
  {
    ...
    src: DEMO_SRC,
    description: [
      'از نصب پارچه‌ی میز فینال تا تمرین بسته‌ی فینالیست‌ها — دوربین ما ۴۸ ساعت در سالن ماند.',
    ],
  ...
  },
  {
    ...
    src: DEMO_SRC,
    description: [
      'سیفتی فقط فرار نیست؛ ساختن تله است. الگوهای رایج سیفتی در اسنوکر و پاسخ درست به هرکدام.',
    ],
  ...
  },
  {
    ...
    src: DEMO_SRC,
    description: [
      'از سالن اصلی با ۱۲ میز مسابقه‌ای تا اتاق VIP و سیستم نور استاندارد — تور کامل باشگاهی که فینال‌های فصل را میزبانی می‌کند.',
    ],
  ...
  },
  {
    ...
    src: DEMO_SRC,
    description: [
      'ساید، تاپ و باتم — با نمای آهسته می‌بینیم هر تماس دقیقاً چه بلایی سر مسیر توپ می‌آورد و کی باید سراغش برویم.',
    ],
  ...
  },
  {
    ...
    src: DEMO_SRC,
    description: [
      'سه برک بالای ۵۰، یک شگفتی بزرگ و بهترین ضربه‌های هفته‌ی افتتاحیه‌ی لیگ بانوان.',
    ],
  ...
  },
  {
    ...
    src: DEMO_SRC,
    description: [
      'بیشتر خطاهای ضربه از استنس غلط شروع می‌شود. چک‌لیست هفت‌مرحله‌ای برای قرارگیری درست پشت میز.',
    ],
  ...
  },
  {
    ...
    src: DEMO_SRC,
    description: [
      'قبل از ضربه‌ی اول، مسیر ۱ تا ۹ را در ذهن بچینید. سه الگوی تمرینی برای تقویت نگاه کلی به میز.',
    ],
  ...
  },
  {
    ...
    src: DEMO_SRC,
    description: [
      'شش گچ پرمصرف بازار را با معیار چسبندگی، پخش‌شدگی و دوام مقایسه کردیم؛ برنده‌ی هر رده مشخص شد.',
    ],
  ...
  },
  {
    ...
    src: DEMO_SRC,
    description: [
      'از چک تجهیزات تا مدیریت لحظه‌های جنجالی — همراه داور بین‌المللی ایرانی در یک روز مسابقه.',
    ],
    tags: ['داوری', 'پشت صحنه'],
  },
  {
    ...
    src: DEMO_SRC,
    description: [
      'از شیفت شب تا صدر جدول — بازیکن ماه از روتین شش‌صبح خودش می‌گوید و سه تمرینی که هرگز حذف نمی‌کند.',
    ],
  ...
  },
  {
    ...
    src: DEMO_SRC,
    description: [
      'مراسم سالانه‌ی معرفی برترین باشگاه‌های شبکه‌ی بیلیارد هاب؛ برندگان، لحظه‌ها و حاشیه‌های شب باشگاه‌ها.',
    ],
