...
export const TECHNICIANS: Technician[] = [
  {
    ...
    intro: 'پارچه‌کشی مسابقه‌ای و رگلاژ میلی‌متری برای میزهایی که باید بی‌نقص بغلتند.',
    about: [
      'از سال ۱۳۹۰ کارم را در کارگاه ساخت میز شروع کردم و از همان‌جا با ظرافت سازه‌ی میزهای اسنوکر آشنا شدم. امروز تمرکزم روی دو چیز است: پارچه‌کشی رده‌ی مسابقه و رگلاژی که با ساعت‌ها بازی هم به‌هم نریزد.',
      'با پارچه‌های Strachan و Hainsworth کار می‌کنم و برای هر نصب، گزارش تراز نقطه‌به‌نقطه تحویل می‌دهم. میزهای مسابقات رسمی چند باشگاه تهران زیر دست من سرویس می‌شوند.',
    ],
    ...
    projects: [
      ...
      { id: 'p3', title: 'بازسازی میز کلاسیک', desc: 'تعویض لاستیک باند، پارچه و احیای چوب بدنه.', city: 'تهران', service: 'بازسازی میز', image: '/images/services/repaire.jfif' },
    ],
    albums: [
      {
        id: 'a1',
        title: 'پروژه‌های تهران',
        desc: 'منتخب نصب‌ها و پارچه‌کشی‌های یک سال اخیر در تهران.',
      ...
      },
      {
        id: 'a2',
        title: 'مراحل بازسازی',
        desc: 'از بازکردن باند تا نتیجه‌ی نهایی — مستند یک بازسازی کامل.',
  ...
  },
  {
    ...
    about: [
      'نجّار خانواده بودم پیش از آن‌که بیلیاردی شوم؛ همین شد که تعمیر سازه‌ی میز برایم زبان مادری است. پانزده سال است میزهای قدیمی و آسیب‌دیده را بازسازی می‌کنم — از تعویض کامل لاستیک باند تا احیای پایه‌های منبت.',
      'باور دارم هیچ میزی «تمام‌شده» نیست؛ فقط منتظر دست درست است.',
    ],
    ...
    projects: [
      ...
      { id: 'p2', title: 'ساخت جیب و قطعات برنجی', desc: 'ساخت سفارشی قطعات ازرده‌خارج برای میز کلاسیک.', city: 'نیشابور', service: 'ساخت و تعمیر قطعات', image: '/images/shop/rest-pool-2.webp' },
    ],
    albums: [
      {
        id: 'a1',
        title: 'بازسازی میزهای مجموعه آفتاب',
        desc: 'مستند نوسازی چهار میز سالن اصلی.',
  ...
  },
  {
    ...
    intro: 'نصب و جابه‌جایی بدون استرس؛ میز سالم می‌رسد، تراز تحویل می‌گیرید.',
    about: [
      'جابه‌جایی میز بیلیارد کار ظریفی است — اسلیت سنگی، چوب حساس و ترازی که نباید قربانی شود. ده سال است با تیم ثابت سه‌نفره‌ام نصب و انتقال میز انجام می‌دهم؛ از طبقه‌ی منفی برج تا ویلای شمال.',
      'هر جابه‌جایی با بیمه‌ی سلامت قطعات و تراز نهایی در محل جدید تحویل داده می‌شود.',
    ],
    ...
    projects: [
      ...
      { id: 'p2', title: 'نصب میز خانگی ۸ فوت', desc: 'نصب در منزل با محدودیت فضای ورود.', city: 'اصفهان', service: 'نصب میز', image: '/images/shop/Home_table.webp' },
    ],
    albums: [
      {
        id: 'a1',
  ...
  },
  {
    ...
    intro: 'تخصصم میزهای پاکت است؛ پارچه‌ی تازه، باند استاندارد و جیب‌های سالم.',
    about: [
      'هشت سال است روی میزهای پاکت بیلیارد کار می‌کنم. تعویض پارچه با Simonis و تعویض لاستیک باند با پروفیل استاندارد K-66 کار هرروز من است.',
      'به باشگاه‌ها سرویس دوره‌ای هم می‌دهم تا میزها همیشه آماده‌ی مسابقه باشند.',
    ],
    services: ['تعویض پارچه', 'تعویض لاستیک باند', 'تعمیر میز', 'رگلاژ و تراز میز'],
    projects: [
      { id: 'p1', title: 'تعویض پارچه و رگلاژ ۶ میز', desc: 'سرویس کامل سالن پیش از لیگ شهری.', city: 'شیراز', club: 'باشگاه پرستیژ', service: 'تعویض پارچه', image: '/images/shop/Pro_table.webp' },
    ],
    albums: [
      {
        id: 'a1',
        title: 'سرویس‌های باشگاه پرستیژ',
        desc: 'پارچه‌کشی و رگلاژ فصل جاری.',
  ...
  },
  {
    ...
    intro: 'چوب شما را مثل روز اول تحویل می‌دهم؛ تیپ، فرول و صافی شفت.',
    about: [
      'کارم تعمیر و سرویس چوب و تجهیزات شخصی است: تعویض تیپ و فرول، رفع تاب شفت، تعویض گریپ و پرداخت نهایی. برای بازیکنان حرفه‌ای، سرویس پیش از مسابقه هم انجام می‌دهم.',
      'اگر چوبتان «حس همیشگی» را ندارد، قبل از تعویض، یک سرویس کامل امتحان کنید.',
    ],
    services: ['خدمات چوب و تجهیزات', 'ساخت و تعمیر قطعات'],
    projects: [
      { id: 'p1', title: 'سرویس چوب‌های تیم استانی', desc: 'تعویض تیپ و بالانس دوازده چوب پیش از مسابقات.', city: 'تبریز', service: 'خدمات چوب و تجهیزات', image: '/images/shop/cue_billiard_2.webp' },
    ],
    albums: [
      {
        id: 'a1',
        title: 'کارگاه چوب',
        desc: 'نمونه‌کارهای سرویس و تعمیر چوب.',
  ...
  },
  {
    ...
    intro: 'تراز دقیق با دوربین لیزری؛ چون یک میلی‌متر هم مهم است.',
    about: [
      'کارم را با تیم نصب یک واردکننده‌ی میز شروع کردم و شش سال است در استان کرمان به‌صورت مستقل کار می‌کنم. برای تراز از دوربین لیزری استفاده می‌کنم و نتیجه را با تست غلتش استاندارد تحویل می‌دهم.',
    ],
    services: ['نصب میز', 'رگلاژ و تراز میز', 'جابه‌جایی میز', 'تعمیر میز'],
    projects: [
      { id: 'p1', title: 'بازسازی میز اسنوکر', desc: 'تعویض پارچه و باند به‌همراه تراز کامل.', city: 'کرمان', club: 'باشگاه ماهان', service: 'بازسازی میز', image: '/images/shop/snooker-table-2.webp' },
      { id: 'p2', title: 'نصب دو میز مسابقه‌ای', desc: 'نصب و تراز برای میزبانی تور استانی.', city: 'رفسنجان', service: 'نصب میز', image: '/images/shop/snooker-table.webp' },
    ],
    albums: [
      {
        id: 'a1',
        title: 'پروژه‌های کرمان',
        desc: 'نصب‌ها و سرویس‌های استان کرمان.',
