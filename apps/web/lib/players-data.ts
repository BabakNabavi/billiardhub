...
export const PLAYERS: Player[] = [
  {
    ...
    intro: 'مرد شماره‌ی یک اسنوکر ایران؛ سه فصل پیاپی صدرنشین رنکینگ ملی.',
    bio: [
      'آرمان توکلی بازی را از چهارده‌سالگی در سالن کوچکی در جنوب تهران شروع کرد؛ جایی که به گفته‌ی خودش «فقط یک میز سالم داشت و همان کافی بود.» ده سال بعد، او پرافتخارترین بازیکن نسل خودش است.',
      'سبک بازی‌اش را با برک‌سازی صبور و سیفتی‌های دقیق می‌شناسند؛ ترکیبی که در فینال قهرمانی کشور با برک ۱۳۲ به کامل‌ترین شکل دیده شد.',
      'او حالا در کنار حضور در اردوهای تیم ملی، روی نخستین حضور ایران در جدول اصلی یک رویداد رنکینگ جهانی تمرکز کرده است.',
    ],
    careerStart: '۱۳۹۴',
    highlights: [
      ...
      { year: '۱۴۰۱', title: 'برک ۱۴۷ رسمی در لیگ برتر' },
    ],
    tournaments: [
  ...
  },
  {
    ...
    intro: 'پرافتخارترین بانوی اسنوکر ایران و نخستین بانوی صاحب برک بالای ۱۰۰ در مسابقات رسمی.',
    bio: [
      'نیلوفر عظیمی با قهرمانی چهار دوره‌ی لیگ بانوان، مرزهای اسنوکر بانوان ایران را جابه‌جا کرده است. برک ۱۰۴ او در فینال ۱۴۰۳، نخستین سنچری ثبت‌شده‌ی بانوان در مسابقات رسمی کشور بود.',
      'او هم‌زمان با بازی، مسیر نسل بعد را هم می‌سازد؛ کلاس‌های هفتگی‌اش برای دختران نوجوان مشهد همیشه تکمیل است.',
    ],
    careerStart: '۱۳۹۶',
    highlights: [
      { year: '۱۴۰۵', title: 'قهرمان لیگ برتر بانوان — چهارمین عنوان' },
      { year: '۱۴۰۳', title: 'نخستین سنچری بانوان در مسابقات رسمی (برک ۱۰۴)' },
  ...
  },
  {
    ...
    intro: 'شماره‌ی یک پاکت بیلیارد ایران؛ قهرمان بی‌رقیب ناین‌بال در دو فصل اخیر.',
    bio: [
      'کاوه شیرازی سریع بازی می‌کند، بی‌پروا حمله می‌کند و به‌ندرت میز را ترک می‌کند؛ سبکی که او را به تماشایی‌ترین بازیکن پاکت بیلیارد ایران تبدیل کرده است.',
      'او در دو فصل گذشته هر دو تور ملی ناین‌بال را برده و حالا نگاهش به مسابقات قهرمانی آسیاست.',
    ],
    careerStart: '۱۳۹۲',
    highlights: [
      { year: '۱۴۰۵', title: 'قهرمان تور ملی ناین‌بال — دومین فصل پیاپی' },
      { year: '۱۴۰۳', title: 'قهرمان تن‌بال کشور' },
  ...
  },
  {
    ...
    intro: 'تاکتیکی‌ترین بازیکن رنکینگ؛ استاد فریم‌های طولانی و جنگ‌های سیفتی.',
    bio: [
      'سینا رستمی را «شطرنج‌باز میز» صدا می‌زنند؛ بازیکنی که با صبر و سیفتی‌های چندلایه حریف را وادار به اشتباه می‌کند و در سه فصل گذشته همیشه بین سه نفر اول رنکینگ بوده است.',
    ],
    careerStart: '۱۳۹۵',
    highlights: [
  ...
  },
  {
    ...
    intro: 'چهره‌ی اول پاکت بیلیارد بانوان و نماینده‌ی ایران در رقابت‌های غرب آسیا.',
    bio: [
      'شیرین کمالی با برد تاریخی‌اش برابر قهرمان سابق غرب آسیا، پاکت بیلیارد بانوان ایران را به نقشه‌ی منطقه برگرداند. ضربه‌ی برک او یکی از قدرتمندترین‌های لیگ است — فارغ از جنسیت.',
    ],
    careerStart: '۱۳۹۷',
    highlights: [
  ...
  },
  {
    ...
    intro: 'پدیده‌ی هفده‌ساله‌ی اسنوکر؛ جوان‌ترین بازیکن تاریخ جمع ده نفر اول رنکینگ.',
    bio: [
      'امیرعلی نجات در شانزده‌سالگی وارد جدول اصلی قهرمانی کشور شد و یک سال بعد، با ورود به جمع ده نفر اول رنکینگ، رکورد کم‌سن‌ترین بازیکن تاریخ این جمع را شکست.',
      'او محصول نسل اول آکادمی ملی استعدادیابی است و کارشناسان او را آینده‌ی اسنوکر ایران می‌دانند.',
    ],
    careerStart: '۱۴۰۲',
    highlights: [
  ...
  },
  {
    ...
    intro: 'متخصص برک‌های سنگین؛ صاحب رکورد بیشترین برد متوالی در لیگ شهری.',
    bio: [
      'بهراد محسنی با چهارده برد متوالی در لیگ شهری مشهد، رکوردی ثبت کرد که هنوز پابرجاست. بازیکنی که بهترین بازی‌اش را در شب‌های حذفی نشان می‌دهد.',
    ],
    careerStart: '۱۳۹۶',
    highlights: [
  ...
  },
  {
    ...
    intro: 'ستاره‌ی نوجوان اسنوکر بانوان؛ قهرمان بلامنازع رده‌ی جوانان.',
    bio: [
      'یسنا پارسا پانزده سال دارد و همین حالا هم در تمرین‌های مشترک، بازیکنان رنکینگ را به چالش می‌کشد. دو قهرمانی پیاپی جوانان، او را به امید اول اسنوکر بانوان تبدیل کرده است.',
    ],
    careerStart: '۱۴۰۳',
    highlights: [
